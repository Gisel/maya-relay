...
.composer textarea:read-only{background:#f2f4f7;color:#667085;cursor:not-allowed}
...
.dropzone.disabled input{pointer-events:none}
...
if(form&&sendButton){
  form.addEventListener('submit', () => {
    ...
    if(replyBody){replyBody.readOnly=true;}
